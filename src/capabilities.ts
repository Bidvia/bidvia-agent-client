...
const bidviaShippedExpandedReadRouteCapabilities: ReadonlyArray<BidviaRouteCapability> = [
  ...
  {
    helperKey: 'listAgentCapabilityProfiles',
    routePathTemplate: '/runtime/agents/:agent_registration_id/capability-profiles',
    httpMethod: 'GET',
    accessContextFamily: 'admin-session',
    requiredContext: ['tenantId', 'adminSessionId'],
    scope: 'read',
  ...
  },
  {
    ...
    routePathTemplate: '/runtime/agents/:agent_registration_id/capability-profiles/:capability_profile_id',
    httpMethod: 'GET',
    accessContextFamily: 'admin-session',
    requiredContext: ['tenantId', 'adminSessionId'],
    scope: 'read',
  ...
  {
    helperKey: 'listCanonicalSemanticTaxonomyEntries',
    routePathTemplate: '/runtime/canonical-semantic-taxonomy-entries',
    httpMethod: 'GET',
    accessContextFamily: 'tenant',
    requiredContext: ['tenantId'],
    scope: 'read',
  ...
  {
    helperKey: 'getCanonicalSemanticTaxonomyEntry',
    routePathTemplate: '/runtime/canonical-semantic-taxonomy-entries/:canonical_semantic_taxonomy_entry_id',
    httpMethod: 'GET',
    accessContextFamily: 'tenant',
    requiredContext: ['tenantId'],
    scope: 'read',
  ...
  {
    helperKey: 'listCanonicalSemanticLineageLinks',
    routePathTemplate: '/runtime/canonical-semantic-lineage-links',
    httpMethod: 'GET',
    accessContextFamily: 'tenant',
    requiredContext: ['tenantId'],
    scope: 'read',
  ...
  {
    helperKey: 'getCanonicalSemanticLineageLink',
    routePathTemplate: '/runtime/canonical-semantic-lineage-links/:canonical_semantic_lineage_link_id',
    httpMethod: 'GET',
    accessContextFamily: 'tenant',
    requiredContext: ['tenantId'],
    scope: 'read',
  ...
  {
    helperKey: 'listFileResources',
    routePathTemplate: '/runtime/file-resources',
    httpMethod: 'GET',
    accessContextFamily: 'tenant',
    requiredContext: ['tenantId'],
    scope: 'read',
  ...
  {
    helperKey: 'getFileResource',
    routePathTemplate: '/runtime/file-resources/:file_resource_id',
    httpMethod: 'GET',
    accessContextFamily: 'tenant',
    requiredContext: ['tenantId'],
    scope: 'read',
