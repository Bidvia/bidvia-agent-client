...
const localCliBindings: readonly BidviaLocalDiscoveryCliBinding[] = [
  ...
  { command: 'agent-capability-profiles', helperKey: 'listAgentCapabilityProfiles', recommendedOutputMode: 'truth-fetch-result' },
  ...
  { command: 'canonical-semantic-taxonomy-entries', helperKey: 'listCanonicalSemanticTaxonomyEntries', recommendedOutputMode: 'truth-fetch-result' },
  { command: 'canonical-semantic-taxonomy-entry', helperKey: 'getCanonicalSemanticTaxonomyEntry', recommendedOutputMode: 'truth-fetch-result' },
  { command: 'canonical-semantic-lineage-links', helperKey: 'listCanonicalSemanticLineageLinks', recommendedOutputMode: 'truth-fetch-result' },
  { command: 'canonical-semantic-lineage-link', helperKey: 'getCanonicalSemanticLineageLink', recommendedOutputMode: 'truth-fetch-result' },
